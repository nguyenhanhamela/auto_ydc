...
fs.readFile('./result_jalan/result_adult1_mealtype3.json', (err, data) => {
    ...
    hotel.forEach(async (prefItem) => {
        ...
        prefItem.hotelList.forEach(async (hotelItem) => {
            ...
            const yesterdayReserverdUrl = "https://www.jalan.net/uw/uwp3200/uww3201init.do?callbackHistFlg=1&contHideFlg=1&childPriceFlg=0,0,0,0,0&roomCrack=200000&stayYear=&stayMonth=&stayDay=&stayCount=1&roomCount=1&dateUndecided=1&adultNum=2&rootCd=041&distCd=01&yadNo=334622&smlCd=020902&mealType=0&screenId=UWW3101&planCd=03483084&roomTypeCd=0498236&planListNumPlan=8__0&groupBookingFlg="
